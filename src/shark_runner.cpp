...
{
	Timer t;
	SURFSReader reader(simulation_params.tree_files_prefix, dark_matter_halos, simulation_params, threads, simulation_params.mask_prefix, simulation_params.mask_name);
