...
public:
	 ...
	 */
  SURFSReader(const std::string &prefix, DarkMatterHalosPtr dark_matter_halos, SimulationParameters simulation_params, unsigned int threads, const std::string &mask_prefix, const std::string &mask_name);
...
private:
	...
	const std::string get_mask_filename(unsigned int batch);
